        ...
        at("History", {
          publicMethods: {
            ...
            onHashChange: function () {
              if (Vn() === zn) return (Hn = true), i.close(), void 0;
...
*/
  ...
  11734: function (t, e, n) {
    ...
    var Animation = n(11735),
      i = n(260);
    n(577), (window.uAnimation = new Animation(i.instance()).init());
  },
          ...
          return (
            ...
            a(el, {
              formatter: function (input, date) {
                ...
                else date = s(date, format || "default");
  ...
  11778: function (t, e, n) {
    ...
    (t.exports = i),
      ...
      (i.prototype.initServices = function t(e, n, products) {
        ...
        if (!a || !stripeMethod) e.find(".u-tab-link").hide();
        if (a)
          this.injectPaypal(e, o, products),
            (this.paypalCurrencyWarning.enabled = true);
        else {
          var s = e.find(".u-payment-stripe.u-tab-pane"),
            tabsControl;
          new TabsControl(s).show();
        }
        if (stripeMethod) this.initStripe(e, o, products);
        if (!stripeMethod && !a) e.find(".u-payment-services").hide();
      }),
        ...
        products.forEach(
          function (product) {
            var t = repeaterItem.clone(),
              ...
              n =
                "true" ===
                t.find(".u-product-price").attr("data-add-zero-cents");
      ...
      (i.prototype.fillItem = function t(e, product) {
        ...
        if (!h.length) h = e.find(".u-product-desc");
        h.text(n),
      ...
      (ProductsBuilder.prototype.applyCategories = function (t, data) {
        ...
        if (e.length) {
          ...
          if ((t.empty(), !data.categories || !data.categories.length))
            return n.html("Uncategorized"), t.append(n), void 0;
